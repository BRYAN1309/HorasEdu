...
import { ArrowLeft, BookOpen, Play, Image, CheckCircle, Clock, FileText, PlayCircle, Pause, Volume2, Maximize, ChevronRight, ChevronLeft, Eye } from "lucide-react";
    ...
    const materialData: any = {
      ...
      `,
        ...
        video: {
            ...
            transcript: "Welcome to this introduction to Aksara Batak. In this video, we'll explore the fundamental aspects of this ancient writing system...",
        },
        image: {
            id: "image-1",
            type: "image",
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${isCompleted ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`}
                            >
                        ...
                        <div className="flex bg-gray-100 rounded-lg p-1">
                            {["article", "video", "image"].map((type) => (
                                <button
                                    ...
                                    className={`px-3 py-1 rounded capitalize text-sm transition-colors ${currentMaterial === type ? "bg-white text-gray-900 shadow-sm" : "text-gray-600 hover:text-gray-800"}`}
                                >
                                    {type}
                                </button>
                            ))}
