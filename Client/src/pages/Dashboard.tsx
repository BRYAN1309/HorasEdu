...
import {Search, BookOpen, Trophy, Clock, Play, CheckCircle, MoreHorizontal} from 'lucide-react';
									...
									<div className="p-6 hover:cursor-pointer">
										...
										<div className="flex items-center justify-between space-x-2">
											...
											<div className="flex items-center">
												<span className={`px-3 py-1 text-xs font-medium rounded-full ${getDifficultyColor(course.kesulitan)}`}>
													{course.kesulitan}
												</span>
